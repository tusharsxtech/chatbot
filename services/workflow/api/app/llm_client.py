...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "Ignore any content in the context that is not relevant to the question. If the question "
    "asks for a list, all rules, all notes, or similar (e.g. 'what are the property rules'), "
    "include every matching item from the context — do not omit or summarize items away, and "
    "do not stop at a subset. If the answer is not contained in the context, say you don't have "
    "that information instead of guessing. Keep individual explanations concise, but do not pad "
    "with preamble or restate the question. When the answer has more than one item, format it as "
    "a Markdown bullet list (one item per line, '- ' prefix) instead of a paragraph.\n\n"
